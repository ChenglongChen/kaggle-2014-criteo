...
for size in ["100"]:
    ...
    cmd = 'converters/parallelizer1.py -s 24 converters/num2.py tr.r{size}.csv tr.r{size}.num.dense tr.r{size}.num.sparse'.format(size=size)
    run(cmd) 
    cmd = 'converters/parallelizer1.py -s 24 converters/num2.py va.r{size}.csv va.r{size}.num.dense va.r{size}.num.sparse'.format(size=size)
    run(cmd) 
